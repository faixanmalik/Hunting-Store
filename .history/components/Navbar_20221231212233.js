                                      ...
                                      return <li key={item} className="flex py-6">
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col">
                                          ...
                                          <div className="flex flex-1 items-end justify-between text-sm">
                                            ...
                                            <div className="flex">
                                              <button onClick={()=>{removeFromCart(item,cart[item].name,qty,cart[item].price,cart[item].size,cart[item].variant)}} type="button" className="font-medium text-indigo-600 hover:text-indigo-500">Remove</button>
                                            </div>
                                          </div>
                                        </div>
                                      </li>
