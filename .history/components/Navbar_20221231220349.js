    ...
    <>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5  mx-auto flex flex-wrap flex-col">
          ...
          {Object.keys(navItem).includes('tshirt') && <button onClick={()=>{}} className={`border-2  rounded-full w-6 h-6 focus:outline-none ${ navItem === 'tshirt' ? 'text-blue-800' : 'text-gray-800' }`}></button>}
