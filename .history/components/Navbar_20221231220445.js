    ...
    <>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5  mx-auto flex flex-wrap flex-col">
          ...
          {Object.keys(variants).includes('Yellow') && <button onClick={()=>{refresh(size , 'Yellow')}} className={`border-2 bg-yellow-600 rounded-full w-6 h-6 focus:outline-none ${ color === 'Yellow' ? 'border-black' : 'border-gray-300' }`}></button>}

          {Object.keys(navItem).includes('tshirt') && <button onClick={()=>{}} className={` sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium bg-gray-100 inline-flex items-center leading-none border-indigo-500 text-indigo-500 tracking-wider rounded-t ${ navItem === 'tshirt' ? 'text-blue-800' : 'text-gray-800' }`}></button>}

          
            <Link value={navItem} href={"/tshirt"} className="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium bg-gray-100 inline-flex items-center leading-none border-indigo-500 text-indigo-500 tracking-wider rounded-t">T_shirts</Link>
            <Link value={navItem} href={"/hoodies"} className="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none border-gray-200 hover:text-gray-900 tracking-wider">Hoodies</Link>
            <Link value={navItem} href={"/mugs"} className="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none border-gray-200 hover:text-gray-900 tracking-wider">Mugs</Link>
          </div>
        </div>
      </section>
    </>
