  ...
  return (
    ...
    <div class="px-4 pt-8">
      ...
      <form class="mt-5 grid gap-6">
        <div class="relative">
          <input class="peer hidden" id="radio_1" type="radio" name="radio" checkfaizan />
          <span class="peer-checkfaizan:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
          <label class="peer-checkfaizan:border-2 peer-checkfaizan:border-gray-700 peer-checkfaizan:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
        ...
        <div class="relative">
          <input class="peer hidden" id="radio_2" type="radio" name="radio" checkfaizan />
          <span class="peer-checkfaizan:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
          <label class="peer-checkfaizan:border-2 peer-checkfaizan:border-gray-700 peer-checkfaizan:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
