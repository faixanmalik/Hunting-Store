...
function Checkout({cart , subTotal, removeFromCart, addToCart }) {
  ...
  const handleChange = (e) => {
    ...
    else if ( e.target.name === 'cardMonth') {
    ...
    <div className="px-4 pt-8">
      ...
      <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
        <div className="flex flex-col rounded-lg bg-white sm:flex-row">
          <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="" alt="" />
      ...
      <form method='POST' onSubmit={submit} className="mt-5 grid gap-6">
        <div className="relative">
