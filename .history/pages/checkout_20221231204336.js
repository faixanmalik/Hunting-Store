    ...
    <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
      ...
      <form method='POST' onSubmit={submit} className="">
        ...
        <div className="flex">
          ...
          <input onChange={handleChange} value={cardExpiry} type="date" name="cardExpiry" className="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="MM/YY" />
