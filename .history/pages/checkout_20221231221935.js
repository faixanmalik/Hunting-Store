      ...
      <form method='POST' onSubmit={submit} className="">
        ...
        <div className="flex flex-col sm:flex-row">
          <div className="relative sm:w-7/12">
            <input onChange={handleChange} value={cardCvc} type="text" id="streetAddress" name="streetAddress" className="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Street Address" />
          </div>
