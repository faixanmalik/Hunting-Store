  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        {Object.keys(product).length === 0 && <div className="font-semibold text-center mx-auto">Sorry! Currently Stock Unavailble right now. Please wait for the new Stock.!</div>}
